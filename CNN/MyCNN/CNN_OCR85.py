...
MODEL_NAME = "data85_model"

n_label = 85  # 标签维度
batch_size = 800  # 每个批次的大小
...
with tf.name_scope('input'):
    ...
    y = tf.placeholder(tf.float32, [None, 85], name='y-input')
...
with tf.name_scope('fc3'):
    ...
    with tf.name_scope('W_fc3'):
        W_fc3 = weight_variable([512, 85], name='W_fc3')
    with tf.name_scope('b_fc3'):
        b_fc3 = bias_variable([85], name='b_fc3')
...
with tf.Session() as sess:
    ...
    # 读取数据
    train_data_npyPath = (r"E:/sxl_Programs/Python/CNN/npy/Img85_features_train_1.npy")  # npy路径
    train_labels_npyPath = (r"E:/sxl_Programs/Python/CNN/npy/Img85_labels_train_1.npy")  # npy路径

    test_data_npyPath = (r"E:/sxl_Programs/Python/CNN/npy/Img85_features_test_1.npy")  # npy路径
    test_labels_npyPath = (r"E:/sxl_Programs/Python/CNN/npy/Img85_labels_test_1.npy")  # npy路径
